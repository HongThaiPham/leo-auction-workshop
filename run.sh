...
echo "
The auction is now complete. The second bidder has won the auction with a bid of 90. The auctioneer has marked the winning bid as the winner and the auction is now closed.
"
